...
export const Step5 = () => {
  ...
  const termYes = () => {
    return <View style={styles.checkedCircle}/>;
  };
  // const handleInputTerms = (value: string) => {
  //   setState({
  //       ...fifthStepState,
  //     terms: value,
  //     },
  ...
  return (
    <>
      ...
      <View style={styles.form}>
        ...
        <TextInput style={styles.inputFormLg}
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.circle}
                            onPress={termYes}>
            {!termYes() ? <View style={styles.checkedCircle}/> : null}
          </TouchableOpacity>
